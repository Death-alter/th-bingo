...
//     }
//     config.mutations[item.mutationName] = createSyncMutation(item.name, item.data);
//   }
...
//     config.mutations = { ...config.mutations, ...createAsyncMutations(item.name, item.actionName) };
